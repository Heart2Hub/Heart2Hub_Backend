...
public class NextOfKinRecordService {
    ...
    public ElectronicHealthRecord deleteAllNextOfKinRecordsFromElectronicHealthRecord(Long electronicHealthRecordId) throws ElectronicHealthRecordNotFoundException {
        try {
            ...
            if (electronicHealthRecordOptional.isPresent()) {
                ...
                existingElectronicHealthRecord.getListOfNextOfKinRecords().clear();
