...
public class DepartmentService {
  ...
  public DepartmentService(DepartmentRepository departmentRepository,
      SubDepartmentService subDepartmentService, StaffRepository staffRepository,
  ...
  public Department createDepartment(Department newDepartment)
      throws UnableToCreateDepartmentException {
    if (!isLoggedInUserAdmin()) {
      throw new UnableToCreateDepartmentException(
          "Staff cannot create departments as he/she is not an admin.");
    }
    try {
  ...
  public Department getDepartmentByName(String name) throws DepartmentNotFoundException {
    return departmentRepository.findByName(name)
        .orElseThrow(() -> new DepartmentNotFoundException("No such department is found"));
  }
